...
const FAQ = () => {
    return (
        <div className="legal-page">
            ...
            <p>Once your order ships, you'll receive a tracking link to monitor its progress. You can also log in to your BigSteppa account to track your orders.</p>
            ...
            <p>Yes, BigSteppa gift cards are available and can be redeemed on our website for any item.</p>
